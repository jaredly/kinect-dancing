...
class CustomShape {
  ...
  CustomShape(float x, float y, float r, Polygon2D bodyPoly) {
    this.r = r;
    this.bodyPoly = bodyPoly;
  ...
  void update() {
    ...
    boolean inBody = bodyPoly.containsPoint(toxiScreen);
